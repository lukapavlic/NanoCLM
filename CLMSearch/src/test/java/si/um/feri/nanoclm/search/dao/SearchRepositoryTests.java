package si.um.feri.nanoclm.search.dao;
...
import si.um.feri.nanoclm.search.vao.filter.AttributeFilter;
import si.um.feri.nanoclm.search.vao.filter.PropertyFilter;
